    ...
    <footer style={{ background: 'var(--bg)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 pb-8">
        <AnimatedSection>
          <div className="grid grid-cols-2 md:grid-cols-12 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-4">
              ...
              <p className="text-sm max-w-xs leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Expert cloud infrastructure, DevOps, and security solutions for modern businesses.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  style={{ background: 'rgba(20,184,166,0.08)', border: '1px solid rgba(20,184,166,0.15)', color: 'var(--text-muted)' }}
                  onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#14b8a6'; e.currentTarget.style.color = '#14b8a6' }}
                  onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(20,184,166,0.15)'; e.currentTarget.style.color = 'var(--text-muted)' }}
                >
            ...
            {Object.entries(footerLinks).map(([title, items]) => (
              <div key={title} className="md:col-span-2 col-span-1 md:col-start-auto">
          ...
          {/* Contact row */}
          <div className="sep-tf mb-8" />
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 flex-shrink-0" style={{ color: '#14b8a6' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
              &copy; 2026 TechFectory. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-xs" style={{ color: 'var(--text-muted)' }}>
              ...
              <a href="#" className="hover:opacity-80 transition-opacity">Cookies</a>
            </div>
          </div>
        </AnimatedSection>
      </div>
